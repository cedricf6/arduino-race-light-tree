...
void resetValues() {
  ...
  rightPreStage = false;
  stageLight = false;
  firstYellowLight = false;
  secondYellowLight = false;
  thirdYellowLight = false;
  greenLight = false;
  leftFalseLight = false;
  rightFalseLight = false;
  raceTreeLightStarted = false;
  raceTreeLightEnded = false;
  myChrono.restart();
}